...
abstract class AbstractPathConfigDescriptor<CT> implements ConfigDescriptor<CT>
{
                                                                    ...
                                                                    Class<? extends Annotation> callbackType)
    {
        ...
        {
            validateSingleDescriptor(foundDescriptors, callbackType);
    ...
    private void validateSingleDescriptor(List<CallbackDescriptor> foundDescriptors, Class<? extends Annotation> callbackType)
    {
