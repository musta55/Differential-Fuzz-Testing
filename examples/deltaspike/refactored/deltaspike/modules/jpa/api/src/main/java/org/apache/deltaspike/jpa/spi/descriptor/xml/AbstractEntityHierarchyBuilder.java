...
public final class AbstractEntityHierarchyBuilder
{
    ...
    protected static void processEntityDescriptor(AbstractEntityDescriptor descriptor,
    ...
    private static AbstractEntityDescriptor findSuperClassDescriptor(Class<?> superClass,
            List<EntityDescriptor> entities, List<MappedSuperclassDescriptor> superClasses)
    {
    ...
    private static void setParentIfNotSet(AbstractEntityDescriptor descriptor, AbstractEntityDescriptor superDescriptor,
            List<EntityDescriptor> entities, List<MappedSuperclassDescriptor> superClasses)
    {
