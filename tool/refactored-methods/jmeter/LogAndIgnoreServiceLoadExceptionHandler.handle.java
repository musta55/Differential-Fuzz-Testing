...
public void handle(Class<?> service, String className, Throwable throwable) {
    if (throwable instanceof NoClassDefFoundError) {
        handleNoClassDefFoundError(service, className, throwable);
    } else {
        handleGenericException(service, className, throwable);
    }
}
// ---- helper method(s) introduced by the refactoring ----
private void handleNoClassDefFoundError(Class<?> service, String className, Throwable throwable) {
    if (throwable.getMessage().contains("javafx")) {
        handleJavaFXMissing(service, className, throwable);
    } else {
...
private void handleJavaFXMissing(Class<?> service, String className, Throwable throwable) {
...
private void handleGenericException(Class<?> service, String className, Throwable throwable) {
