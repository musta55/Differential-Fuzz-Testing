...
protected void updateData(SummaryInfo info, Sample sample) {
    ...
    if (!sample.isEmptyController()) {
        aggregateSample(sample, info.getData(), false, ignoreTCFromTop5ErrorsBySampler);
        aggregateSample(sample, overallInfo.getData(), true, ignoreTCFromTop5ErrorsBySampler);
    }
}
