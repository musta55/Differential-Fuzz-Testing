private static void installPlugin(JMeterPlugin plugin) {
    ...
    for (String[] icon : icons) {
        ...
        if (resource == null) {
            ...
            ImageIcon disabledIcon = createDisabledIcon(icon, classloader, regularIcon);
...
private static ImageIcon createDisabledIcon(String[] icon, ClassLoader classloader, ImageIcon regularIcon) {
