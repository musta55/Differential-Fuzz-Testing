...
public void doAction(ActionEvent e) {
    ...
    insertNodes(treeModel, parentNode, currentNode, copiedNodes);
    instance.getMainFrame().repaint();
}
// ---- helper method(s) introduced by the refactoring ----
private static void insertNodes(JMeterTreeModel treeModel, JMeterTreeNode parentNode, JMeterTreeNode currentNode, JMeterTreeNode[] copiedNodes) {
