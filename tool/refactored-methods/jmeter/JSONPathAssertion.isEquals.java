private boolean isEquals(Object subj) {
    if (isUseRegex()) {
        ...
        return USE_JAVA_REGEX ? JMeterUtils.compilePattern(getExpectedValue()).matcher(str).matches() : JMeterUtils.getMatcher().matches(str, JMeterUtils.getPatternCache().getPattern(getExpectedValue()));
    } else {
