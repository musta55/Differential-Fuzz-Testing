...
public String execute(SampleResult previousResult, Sampler currentSampler) throws InvalidVariableException {
    ...
    String resultStr = "";
    if (useRhinoEngine) {
        resultStr = executeWithEngine(previousResult, currentSampler, jmctx, vars, script, varName, true);
    } else {
        resultStr = executeWithEngine(previousResult, currentSampler, jmctx, vars, script, varName, false);
    }
    return resultStr;
}
