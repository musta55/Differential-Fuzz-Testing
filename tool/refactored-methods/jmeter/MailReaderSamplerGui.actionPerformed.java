...
public void actionPerformed(ActionEvent e) {
    String item = serverTypeBox.getText();
    boolean isPop3 = item.equals("pop3") || item.equals("pop3s");
    folderLabel.setEnabled(!isPop3);
    folderBox.setEnabled(!isPop3);
    folderBox.setText(isPop3 ? INBOX : folderBox.getText());
}
