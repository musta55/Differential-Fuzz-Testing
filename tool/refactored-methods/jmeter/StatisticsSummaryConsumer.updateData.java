...
protected void updateData(SummaryInfo info, Sample sample) {
    ...
    StatisticsSummaryData overallData = getOrCreateData(overallInfo, PERCENTILE_INDEX1, PERCENTILE_INDEX2, PERCENTILE_INDEX3);
    StatisticsSummaryData data = getOrCreateData(info, PERCENTILE_INDEX1, PERCENTILE_INDEX2, PERCENTILE_INDEX3);
