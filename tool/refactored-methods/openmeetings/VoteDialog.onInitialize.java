...
private void addButtons() {
    addButton(createVoteButton());
    addButton(OmModalCloseButton.of());
}

private BootstrapAjaxButton createVoteButton() {
    return new BootstrapAjaxButton(BUTTON_MARKUP_ID, new ResourceModel("32"), form, Buttons.Type.Outline_Primary) {
