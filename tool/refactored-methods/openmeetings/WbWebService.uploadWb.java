        ...
        try {
            ...
            if (EXTENSION_PDF.equals(type)) {
                try (PDDocument doc = new PDDocument();
                    ...
                    processPdfData(data, doc);
                    doc.save(os);
                }
            } else {
                processPngData(data, tDir, fuid);
            }
...
private void processPdfData(String data, PDDocument doc) throws Exception {
...
private void processPngData(String data, String tDir, String fuid) throws Exception {
    JSONArray arr = new JSONArray(data);
