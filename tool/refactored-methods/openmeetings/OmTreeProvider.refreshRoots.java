public void refreshRoots(boolean all) {
    List<BaseFileItem> fRoot = new ArrayList<>();
    List<BaseFileItem> rRoot = new ArrayList<>();
    addUserSpecificRoots(all, fRoot, rRoot);
    addRoomSpecificRoots(fRoot);
    addGroupSpecificRoots(all, rRoot, fRoot);
    updateRoots(fRoot, rRoot);
}
