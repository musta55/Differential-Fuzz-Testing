...
private void addCaptchaTextField() {
    add(captchaText.setLabel(new ResourceModel("captcha.text")).add(createCaptchaValidator()).setOutputMarkupId(true).add(AttributeModifier.append("placeholder", lang.getTip())));
}

private IValidator<String> createCaptchaValidator() {
